// CoordCloak - Content Script
// Runs at document_start in an isolated context.
// We inject a <script> tag into the actual page context so we can
// override navigator.geolocation (content scripts can't do this directly).
...
// Load saved settings and inject immediately (we run at document_start)
...
// Also listen for live updates from the popup while the page is open
