(function(t, e) {
  ...
  function j(t, e, i) {
    ...
    var o, s, r = function() {
      o 
        ? s = arguments 
        : (t.apply(i, arguments), setTimeout(n, e), o = !0);
    };
    return r;
  }
  ...
  var Q = window.cancelAnimationFrame || Y("CancelAnimationFrame") || Y("CancelRequestAnimationFrame") || function(t) {
  ...
  var e = {
      ...
      if (this._events && (n = this._events[t])) {
        if (1 === arguments.length) {
          if (this._firingCount) {
            for (o = 0, s = n.length; o < s; o++) n[o].fn = _;
          }
          delete this._events[t];
        } else {
          if ("function" != typeof e) {
            console.warn("wrong listener type: " + typeof e);
          } else if (!1 !== (e = this._listens(t, e, i))) {
            i = n[e];
            this._firingCount && (i.fn = _, this._events[t] = n = n.slice()), n.splice(e, 1);
          }
        }
      }
    },
    ...
    listens: function(t, e, i, n) {
      ...
      var o = e;
      var s = ("function" != typeof e && (n = !!e, i = o = void 0), this._events && this._events[t]);
  ...
  var it = (e.addEventListener = e.on, e.removeEventListener = e.clearAllEventListeners = e.off, e.addOneTimeEventListener = e.once, e.fireEvent = e.fire, e.hasEventListeners = e.listens, et.extend(e));
  ...
  f.prototype = {
    extend: function(t) {
      ...
      if (t) {
        if (t instanceof p || "number" == typeof t[0] || "x" in t) {
          e = i = m(t);
        } else if (e = (t = c(t)).min, i = t.max, !e || !i) {
          return this;
        }
        this.min || this.max 
    ...
    contains: function(t) {
      var e, i;
      return (t = ("number" == typeof t[0] || t instanceof p ? m : c)(t)) instanceof f 
        ? (e = t.min, i = t.max) 
        : e = i = t, e.x >= this.min.x && i.x <= this.max.x && e.y >= this.min.y && i.y <= this.max.y;
    },
    intersects: function(t) {
      t = c(t);
      var e = this.min, i = this.max, n = t.min;
      var o = (t = t.max).x >= e.x && n.x <= i.x;
      var t = t.y >= e.y && n.y <= i.y;
      return o && t;
    },
    overlaps: function(t) {
      t = c(t);
    ...
    pad: function(t) {
      ...
      var n = Math.abs(e.x - i.x) * t;
      var t = Math.abs(e.y - i.y) * t;
  ...
  s.prototype = {
    extend: function(t) {
      ...
      return n || o 
        ...
        : (this._southWest = new v(e.lat, e.lng), this._northEast = new v(i.lat, i.lng)), this;
    },
    pad: function(t) {
      var e = this._southWest, i = this._northEast;
      var n = Math.abs(e.lat - i.lat) * t;
      var t = Math.abs(e.lng - i.lng) * t;
    ...
    contains: function(t) {
      ...
      return t instanceof s 
        ...
        : e = i = t, e.lat >= n.lat && i.lat <= o.lat && e.lng >= n.lng && i.lng <= o.lng;
    },
    intersects: function(t) {
      t = g(t);
      var e = this._southWest, i = this._northEast;
      var n = t.getSouthWest();
      var o = (t = t.getNorthEast()).lat >= e.lat && n.lat <= i.lat;
      var t = t.lng >= e.lng && n.lng <= i.lng;
      return o && t;
    },
    overlaps: function(t) {
      t = g(t);
  ...
  var ot = {
    ...
    getProjectedBounds: function(t) {
      ...
      return this.infinite 
        ? null 
        : (e = this.projection.bounds, t = this.scale(t), new f(this.transformation.transform(e.min, t), this.transformation.transform(e.max, t)));
    },
    ...
    wrapLatLngBounds: function(t) {
      var e = t.getCenter(), i = this.wrapLatLng(e);
      var n = e.lat - i.lat;
      var e = e.lng - i.lng;
      return 0 == n && 0 == e 
        ? t 
  ...
  var st = l({}, ot, {
    ...
    distance: function(t, e) {
      var i = Math.PI / 180;
      var n = t.lat * i, o = e.lat * i;
      var s = Math.sin((e.lat - t.lat) * i / 2);
      var e = Math.sin((e.lng - t.lng) * i / 2);
      var t = s * s + Math.cos(n) * Math.cos(o) * e * e;
      var i = 2 * Math.atan2(Math.sqrt(t), Math.sqrt(1 - t));
      return this.R * i;
    }
  });
  ...
  var rt = {
    ...
    project: function(t) {
      var e = Math.PI / 180;
      var i = this.MAX_LATITUDE;
      var i = Math.max(Math.min(i, t.lat), -i);
      var i = Math.sin(i * e);
  ...
  var pt = (Me = "ActiveXObject" in window) && !document.addEventListener;
  var n = "msLaunchUri" in navigator && !("documentMode" in document);
  var mt = w("webkit");
  var ft = w("android");
  var gt = w("android 2") || w("android 3");
  var vt = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10);
  var vt = ft && w("Google") && vt < 537 && !("AudioNode" in window);
  var yt = !!window.opera;
  var xt = !n && w("chrome");
  var wt = w("gecko") && !mt && !yt && !Me;
  var bt = !xt && w("safari");
  var Pt = w("phantom");
  var o = "OTransition" in _t;
  var Lt = 0 === navigator.platform.indexOf("Win");
  var Tt = Me && "transition" in _t;
  var Mt = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix && !gt;
  var _t = "MozPerspective" in _t;
  var zt = !window.L_DISABLE_3D && (Tt || Mt || _t) && !o && !Pt;
  var Ct = (Gi = "undefined" != typeof orientation || w("mobile")) && mt;
  var Zt = Gi && Mt;
  var St = !window.PointerEvent && window.MSPointerEvent;
  var Et = !(!window.PointerEvent && !St);
  var kt = "ontouchstart" in window || !!window.TouchEvent;
  var Ot = !window.L_NO_TOUCH && (kt || Et);
  var At = Gi && yt;
  var Bt = Gi && wt;
  var It = 1 < (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI);
  var Rt = function() {
    var t = !1;
    try {
  ...
  var Nt = !!document.createElement("canvas").getContext;
  var Dt = !(!document.createElementNS || !ct("svg").createSVGRect);
  var jt = !!Dt && ((jt = document.createElement("div")).innerHTML = "<svg/>", "http://www.w3.org/2000/svg" === (jt.firstChild && jt.firstChild.namespaceURI));
  ...
  var b = {
    ...
    vml: !Dt && function() {
      try {
        ...
        var e = (t.innerHTML = '<v:shape adj="1"/>', t.firstChild);
  ...
  var Ht = b.msPointer ? "MSPointerDown" : "pointerdown";
  var Wt = b.msPointer ? "MSPointerMove" : "pointermove";
  var Ft = b.msPointer ? "MSPointerUp" : "pointerup";
  var Ut = b.msPointer ? "MSPointerCancel" : "pointercancel";
  var Vt = {
    touchstart: Ht,
    touchmove: Wt,
    touchend: Ft,
  ...
  var Qt = 200;
  var te, ee, ie, ne, oe;
  var se = fe(["transform", "webkitTransform", "OTransform", "MozTransform", "msTransform"]);
  var re = fe(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]);
  var ae = "webkitTransition" === re || "OTransition" === re ? re + "End" : "transitionend";
  ...
  function le(t, e) {
    ...
    return "auto" === (i = i && "auto" !== i || !document.defaultView 
      ? i 
  ...
  function _e(t, e) {
    return void 0 !== t.classList 
      ...
      : 0 < (t = me(t)).length && new RegExp("(^|\\s)" + e + "(\\s|$)").test(t);
  }
  ...
  function S(t, e, i, n) {
    if (e && "object" == typeof e) {
      ...
      for (var s = 0, r = (e = F(e)).length; s < r; s++) Ze(t, e[s], i, n);
    }
    return this;
  }

  var Te = "onselectstart" in document 
    ? (ie = function() { S(window, "selectstart", O); }, function() { k(window, "selectstart", O); }) 
    : (ee = fe(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]), ie = function() {
        var t;
  ...
  var Me = {
    ...
    setPosition: Z,
    getPosition: ve,
    get disableTextSelection() { return ie; },
    get enableTextSelection() { return Te; },
    disableImageDrag: ye,
    enableImageDrag: xe,
    preventOutline: we,
    restoreOutline: be,
  ...
  function k(t, e, i, n) {
    if (1 === arguments.length) {
      ...
      for (var o in e) Se(t, o, e[o], i);
    } else if (e = F(e), 2 === arguments.length) {
      ze(t, function(t) { return -1 !== G(e, t); });
    } else {
      for (var s = 0, r = e.length; s < r; s++) Se(t, e[s], i, n);
    }
    return this;
  }
  ...
  function Ze(e, t, i, n) {
    ...
    function c(t) {
      ...
      1 !== t.detail 
        ? h = t.detail 
        : "mouse" === t.pointerType || t.sourceCapabilities && !t.sourceCapabilities.firesTouchEvents || (e = Be(t)).some(function(t) { return t instanceof HTMLLabelElement && t.attributes.for; }) && !e.some(function(t) { return t instanceof HTMLInputElement || t instanceof HTMLSelectElement; }) || ((e = Date.now()) - l <= Qt 
          ? 2 == ++h && a(function(t) {
              var e, i, n = {};
    ...
    e[E] && e[E][u] || (s = o = function(t) { return i.call(n || e, t || window.event); }, !b.touchNative && b.pointer && 0 === t.indexOf("touch") 
      ? o = function(t, e, i) {
          return "touchstart" !== e || Kt || (document.addEventListener(Ht, Yt, !0), document.addEventListener(Wt, Xt, !0), document.addEventListener(Ft, Jt, !0), document.addEventListener(Ut, Jt, !0), Kt = !0), qt[e] 
            ? (i = qt[e].bind(this, i), t.addEventListener(Vt[e], i, !1), i) 
            : (console.warn("wrong event specified:", e), _);
        }(e, t, o) 
      : b.touch && "dblclick" === t 
        ? (a = o, (r = e).addEventListener("dblclick", a), l = 0, r.addEventListener("click", c), o = {
            dblclick: a,
            simDblclick: c
          }) 
        : "addEventListener" in e 
          ? "touchstart" === t || "touchmove" === t || "wheel" === t || "mousewheel" === t 
            ...
            : "mouseenter" === t || "mouseleave" === t 
              ? e.addEventListener(Ce[t], o = function(t) {
                  t = t || window.event, De(e, t) && s(t);
                }, !1) 
              : e.addEventListener(t, s, !1) 
          : e.attachEvent("on" + t, o), e[E] = e[E] || {}, e[E][u] = o);
  }

  function Se(t, e, i, n, o) {
    var s, r;
    o = o || e + d(i) + (n ? "_" + d(n) : "");
    (i = t[E] && t[E][o]) && (!b.touchNative && b.pointer && 0 === e.indexOf("touch") 
      ...
      : b.touch && "dblclick" === e 
        ...
        : "removeEventListener" in t 
          ...
          : t.detachEvent("on" + e, i), t[E][o] = null);
  }
  ...
  function Ie(t, e) {
    var i, n;
    return e 
      ? (n = (i = Le(e)).boundingClientRect, new p((t.clientX - n.left) / i.x - e.clientLeft, (t.clientY - n.top) / i.y - e.clientTop)) 
      : new p(t.clientX, t.clientY);
  }

  var Re = b.linux && b.chrome 
  ...
  var A = it.extend({
    ...
    setView: function(t, e, i) {
      ...
      i = i || {};
      this._stop();
      if (this._loaded && !i.reset && !0 !== i && (void 0 !== i.animate && (i.zoom = l({ animate: i.animate }, i.zoom), i.pan = l({ animate: i.animate, duration: i.duration }, i.pan)), this._zoom !== e ? this._tryAnimatedZoom && this._tryAnimatedZoom(t, e, i.zoom) : this._tryAnimatedPan(t, i.pan))) {
    ...
    setZoomAround: function(t, e, i) {
      ...
      var t = (t instanceof p ? t : this.latLngToContainerPoint(t)).subtract(o).multiplyBy(1 - 1 / n);
      var n = this.containerPointToLatLng(o.add(t));
    ...
    _getBoundsCenterZoom: function(t, e) {
      ...
      var n = m(e.paddingBottomRight || e.padding || [0, 0]);
      var o = this.getBoundsZoom(t, !1, i.add(n));
    ...
    panBy: function(t, e) {
      ...
      return e = e || {}, (t = m(t).round()).x || t.y 
        ? (!0 === e.animate || this.getSize().contains(t) 
          ? (this._panAnim || (this._panAnim = new je, this._panAnim.on({
          ...
          : this._resetView(this.unproject(this.project(this.getCenter()).add(t)), this.getZoom()), this) 
        : this.fire("moveend");
    },
    flyTo: function(o, s, t) {
      ...
      var a = this.project(o);
      var e = this.getSize();
      var h = this._zoom;
      var l = (o = x(o), s = void 0 === s ? h : s, Math.max(e.x, e.y));
      var i = l * this.getZoomScale(h, s);
      var u = a.distanceTo(r) || 1;
      var c = 1.42;
      var d = c * c;

      function n(t) {
        return t = (i * i - l * l + (t ? -1 : 1) * d * d * u * u) / (2 * (t ? i : l) * d * u);
        return (t = Math.sqrt(t * t + 1) - t) < 1e-9 ? -18 : Math.log(t);
      }
      ...
      var f = Date.now();
      var g = (n(1) - m) / c;
      var v = t.duration ? 1000 * t.duration : 1000 * g * 0.8;
      return this._moveStart(!0, t.noMoveStart), function t() {
        var e, i = (Date.now() - f) / v;
        var n = (1 - Math.pow(1 - i, 1.5)) * g;
        i <= 1 
          ? (this._flyToFrame = y(t, this), this._move(this.unproject(r.add(a.subtract(r).multiplyBy((e = n, l * (p(m) * (_(e = m + c * e) / p(e)) - _(m)) / d / u))), h), this.getScaleZoom(l / (i = n, l * (p(m) / p(m + c * i))), h), { flyTo: !0 })) 
    ...
    setMaxBounds: function(t) {
      return t = g(t), this.listens("moveend", this._panInsideMaxBounds) && this.off("moveend", this._panInsideMaxBounds), t.isValid() 
        ? (this.options.maxBounds = t, this._loaded && this._panInsideMaxBounds(), this.on("moveend", this._panInsideMaxBounds)) 
        : (this.options.maxBounds = null, this);
    },
    setMinZoom: function(t) {
      var e = this.options.minZoom;
      return this.options.minZoom = t, this._loaded && e !== t && (this.fire("zoomlevelschange"), this.getZoom() < this.options.minZoom) 
        ? this.setZoom(t) 
        : this;
    },
    setMaxZoom: function(t) {
      var e = this.options.maxZoom;
      return this.options.maxZoom = t, this._loaded && e !== t && (this.fire("zoomlevelschange"), this.getZoom() > this.options.maxZoom) 
        ? this.setZoom(t) 
        : this;
    },
    panInsideBounds: function(t, e) {
      ...
      var t = this._limitCenter(i, this._zoom, g(t));
    ...
    panInside: function(t, e) {
      ...
      var t = this.project(t);
      var s = (i = c([(s = this.getPixelBounds()).min.add(i), s.max.subtract(n)])).getSize();
    ...
    invalidateSize: function(t) {
      ...
      var e = this.getSize();
      var i = (this._sizeChanged = !0, this._lastCenter = null, this.getSize());
      var n = e.divideBy(2).round();
      var o = i.divideBy(2).round();
      return (n = n.subtract(o)).x || n.y 
        ? (t.animate && t.pan 
          ? this.panBy(n) 
          : (t.pan && this._rawPanBy(n), this.fire("move"), t.debounceMoveend 
              ? (clearTimeout(this._sizeTimer), this._sizeTimer = setTimeout(a(this.fire, this, "moveend"), 200)) 
              : this.fire("moveend")), this.fire("resize", { oldSize: e, newSize: i }), this) 
        : this;
    },
    stop: function() {
    ...
    locate: function(t) {
      var e, i;
      return t = this._locateOptions = l({ timeout: 1e4, watch: !1 }, t), "geolocation" in navigator 
        ? (e = a(this._handleGeolocationResponse, this), i = a(this._handleGeolocationError, this), t.watch 
    ...
    _handleGeolocationResponse: function(t) {
      if (this._container._leaflet_id) {
        ...
        var o = n.toBounds(2 * t.coords.accuracy);
        var s = this._locateOptions;
        var r = (s.setView && (e = this.getBoundsZoom(o), this.setView(n, s.maxZoom ? Math.min(e, s.maxZoom) : e)), {
          latlng: n,
          bounds: o,
    ...
    getBoundsZoom: function(t, e, i) {
      ...
      var t = t.getSouthEast();
      var i = this.getSize().subtract(i);
      var t = c(this.project(t, n), this.project(r, n)).getSize();
      var r = b.any3d ? this.options.zoomSnap : 1;
      var a = i.x / t.x;
      var i = i.y / t.y;
      var t = e ? Math.max(a, i) : Math.min(a, i);
    ...
    getScaleZoom: function(t, e) {
      var i = this.options.crs;
      var t = (e = void 0 === e ? this._zoom : e, i.zoom(t * i.scale(e)));
    ...
    _initLayout: function() {
      ...
      var e = (this._fadeAnimated = this.options.fadeAnimation && b.any3d, M(t, "leaflet-container" + (b.touch ? " leaflet-touch" : "") + (b.retina ? " leaflet-retina" : "") + (b.ielt9 ? " leaflet-oldie" : "") + (b.safari ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : "")), le(t, "position"));
    ...
    _resetView: function(t, e, i) {
      Z(this._mapPane, new p(0, 0));
      var n = !this._loaded;
      var o = (this._loaded = !0, e = this._limitZoom(e), this.fire("viewprereset"), this._zoom !== e);
    ...
    _move: function(t, e, i, n) {
      ...
      var o = this._zoom !== e;
      return this._zoom = e, this._lastCenter = t, this._pixelOrigin = this._getNewPixelOrigin(t), n 
        ? i && i.pinch && this.fire("zoom", i) 
        : ((o || i && i.pinch) && this.fire("zoom", i), this.fire("move", i)), this;
    },
    _moveEnd: function(t) {
    ...
    _onResize: function() {
      ...
      this._resizeRequest = y(function() { this.invalidateSize({ debounceMoveend: !0 }); }, this);
    },
    _onScroll: function() {
    ...
    _getBoundsOffset: function(t, e, i) {
      return i = (e = c(this.project(e.getNorthEast(), i), this.project(e.getSouthWest(), i))).min.subtract(t.min), e = e.max.subtract(t.max), new p(this._rebound(i.x, -e.x), this._rebound(i.y, -e.y));
    },
    ...
    _limitZoom: function(t) {
      ...
      var n = b.any3d ? this.options.zoomSnap : 1;
    ...
    _tryAnimatedZoom: function(t, e, i) {
      if (!this._animatingZoom) {
        ...
        var n = this.getZoomScale(e);
        var n = this._getCenterOffset(t)._divideBy(1 - 1 / n);
        if (!0 !== i.animate && !this.getSize().contains(n)) return !1;
        y(function() { this._moveStart(!0, i.noMoveStart || !1)._animateZoom(t, e, !0); }, this);
      }
      return !0;
    },
  ...
  var B = et.extend({
    ...
    initialize: function(t) { h(this, t); },
  ...
  var We = (A.include({
    ...
    _initControlPos: function() {
      ...
      var n = "leaflet-";
      var o = this._controlContainer = P("div", n + "control-container", this._container);
    ...
    options: {
      ...
      hideSingleBase: !1,
      sortLayers: !1,
      sortFunction: function(t, e, i, n) { return i < n ? -1 : n < i ? 1 : 0; }
    },
    initialize: function(t, e, i) {
      for (var n in h(this, i), this._layerControlInputs = [], this._layers = [], this._lastZIndex = 0, this._handlingClick = !1, this._preventClick = !1, t) this._addLayer(t[n], n);
    ...
    _initLayout: function() {
      ...
      var e = this._container = P("div", t);
      var i = this.options.collapsed;
      var n = (e.setAttribute("aria-haspopup", !0), Oe(e), ke(e), this._section = P("section", t + "-list"));
      var o = (i && (this._map.on("click", this.collapse, this), S(e, { mouseenter: this._expandSafely, mouseleave: this.collapse }, this)), this._layersLink = P("a", t + "-toggle", e));
      o.href = "#";
      o.title = "Layers";
      o.setAttribute("role", "button");
      S(o, { keydown: function(t) { 13 === t.keyCode && this._expandSafely(); }, click: function(t) { O(t), this._expandSafely(); } }, this);
      i || this.expand();
    ...
    _addLayer: function(t, e, i) {
      ...
      this.options.sortLayers && this._layers.sort(a(function(t, e) { return this.options.sortFunction(t.layer, e.layer, t.name, e.name); }, this));
    ...
    _onLayerChange: function(t) {
      ...
      var t = (e.overlay ? "add" === t.type ? "overlayadd" : "overlayremove" : "add" === t.type ? "baselayerchange" : null);
    ...
    _addItem: function(t) {
      ...
      var n = this._map.hasLayer(t.layer);
      t.overlay 
    ...
    _expandSafely: function() {
      var t = this._section;
      var e = (this._preventClick = !0, S(t, "click", O), this.expand(), this);
  ...
  var Fe = B.extend({
    ...
    _createButton: function(t, e, i, n, o) {
      return (i = P("a", i, n)).innerHTML = t, i.href = "#", i.title = e, i.setAttribute("role", "button"), i.setAttribute("aria-label", e), Oe(i), S(i, "click", Ae), S(i, "click", o, this), S(i, "click", this._refocusOnMap, this), i;
    },
    _updateDisabled: function() {
      var t = this._map;
      var e = "leaflet-disabled";
  ...
  var Ue = (A.mergeOptions({ zoomControl: !0 }), A.addInitHook(function() {
    ...
    _update: function() {
      ...
      var e = e.distance(e.containerPointToLatLng([0, t]), e.containerPointToLatLng([this.options.maxWidth, t]));
  ...
  var Ve = B.extend({
    ...
    _addAttribution: function(t) {
      t.layer.getAttribution && (this.addAttribution(t.layer.getAttribution()), t.layer.once("remove", function() { this.removeAttribution(t.layer.getAttribution()); }, this));
    },
  ...
  B.Scale = Ue;
  B.Attribution = Ve;
  He.layers = function(t, e, i) { return new We(t, e, i); };
  He.zoom = function(t) { return new Fe(t); };
  He.scale = function(t) { return new Ue(t); };
  He.attribution = function(t) { return new Ve(t); };
  ...
  })).addTo = function(t, e) { return t.addHandler(e, this), this; };

  var mt = { Events: e };
  var qe = b.touch ? "touchstart mousedown" : "mousedown";
  ...
  var Ge = it.extend({
    ...
    _onDown: function(t) {
      var e, i;
      this._enabled && (this._moved = !1, _e(this._element, "leaflet-zoom-anim") || (t.touches && 1 !== t.touches.length 
        ? Ge._dragging === this && this.finishDrag() 
        : Ge._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || ((Ge._dragging = this)._preventOutline && we(this._element), ye(), ie(), this._moving || (this.fire("down"), i = t.touches ? t.touches[0] : t, e = Pe(this._element), this._startPoint = new p(i.clientX, i.clientY), this._startPos = ve(this._element), this._parentScale = Le(e), i = "mousedown" === t.type, S(document, i ? "mousemove" : "touchmove", this._onMove, this), S(document, i ? "mouseup" : "touchend touchcancel", this._onUp, this)))));
    },
    _onMove: function(t) {
      var e;
      this._enabled && (t.touches && 1 < t.touches.length 
        ? this._moved = !0 
  ...
  function Ye(t, e) {
    ...
    for (var l = x([0, 0]), u = g(t), c = (u.getNorthWest().distanceTo(u.getSouthWest()) * u.getNorthEast().distanceTo(u.getNorthWest()) < 1700 && (l = Xe(t)), t.length), d = [], _ = 0; _ < c; _++) {
      var p = x(t[_]);
    ...
    u = 0 === r ? d[0] : [a / r, h / r];
    return x([(u = e.unproject(m(u))).lat + l.lat, u.lng + l.lng]);
  }
    ...
    if (e && t.length) {
      var i = t = function(t, e) {
        for (var i, n, o, s = [t[0]], r = 1, a = 0, h = t.length; r < h; r++) {
          ...
          n = t[a];
          o = void 0;
          (o = n.x - i.x) * o + (n = n.y - i.y) * n > e && (s.push(t[r]), a = r);
        }
        return a < h - 1 && s.push(t[h - 1]), s;
      }(t, e *= e);
      var n = i.length;
      var o = new(typeof Uint8Array != void 0 + "" ? Uint8Array : Array)(n);
      o[0] = o[n - 1] = 1;

      function t(e, i, n, o, s) {
        for (var r, a, h = 0, l = o + 1; l <= s - 1; l++) {
          h < (a = ni(e[l], e[o], e[s], !0)) && (r = l, h = a);
        }
    ...
    return 8 & i 
      ...
      : 4 & i 
        ...
        : 2 & i 
          ...
          : 1 & i && (s = h.x, r = t.y + e * (h.x - t.x) / a), new p(s, r, o);
  }
  ...
  function ni(t, e, i, n) {
    ...
    var r = i.y - e;
    var a = s * s + r * r;
    return 0 < a && (1 < (a = ((t.x - o) * s + (t.y - e) * r) / a) 
      ? (o = i.x, e = i.y) 
      : 0 < a && (o += s * a, e += r * a)), s = t.x - o, r = t.y - e, n ? s * s + r * r : new p(o, e);
  }
  ...
  function si(t, e) {
    ...
    if (!t || 0 === t.length) throw new Error("latlngs not passed");
    I(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
    for (var h = x([0, 0]), l = g(t), u = (l.getNorthWest().distanceTo(l.getSouthWest()) * l.getNorthEast().distanceTo(l.getNorthWest()) < 1700 && (h = Xe(t)), t.length), c = [], d = 0; d < u; d++) {
      var _ = x(t[d]);
      c.push(e.project(x([_.lat - h.lat, _.lng - h.lng])));
    }
    for (i = d = 0; d < u - 1; d++) i += c[d].distanceTo(c[d + 1]) / 2;
    if (0 === i) a = c[0];
    else for (n = d = 0; d < u - 1; d++) {
  ...
  var gt = {
    ...
    closestPointOnSegment: function(t, e, i) { return ni(t, e, i); },
    clipSegment: ti,
  ...
  var xt = {
    __proto__: null,
    LonLat: vt = {
      project: function(t) { return new p(t.lng, t.lat); },
      unproject: function(t) { return new v(t.y, t.x); },
    ...
    Mercator: yt = {
      ...
      project: function(t) {
        ...
        var i = this.R;
        var n = t.lat * e;
        var o = this.R_MINOR / i;
        var s = (o = Math.sqrt(1 - o * o)) * Math.sin(n);
        var s = Math.tan(Math.PI / 4 - n / 2) / Math.pow((1 - s) / (1 + s), o / 2);
        var n = -i * Math.log(Math.max(s, 1e-10));
  ...
  var o = (ot.Earth = st, ot.EPSG3395 = bt, ot.EPSG3857 = lt, ot.EPSG900913 = ut, ot.EPSG4326 = ri, ot.Simple = Pt, it.extend({
    ...
    addInteractiveTarget: function(t) { return this._map._targets[d(t)] = this; },
    removeInteractiveTarget: function(t) { return delete this._map._targets[d(t)], this; },
  ...
  var ai = (A.include({
    ...
    hasLayer: function(t) { return d(t) in this._layers; },
  ...
  var hi = ai.extend({
    addLayer: function(t) {
      return this.hasLayer(t) 
        ? this 
        : (t.addEventParent(this), ai.prototype.addLayer.call(this, t), this.fire("layeradd", { layer: t }));
    },
    removeLayer: function(t) {
      return this.hasLayer(t) 
  ...
  var li = et.extend({
    ...
    _setIconStyles: function(t, e) {
      var i = this.options;
      var n = m(n = "number" == typeof (n = i[e + "Size"]) ? [n, n] : n);
      var o = m("shadow" === e && i.shadowAnchor || i.iconAnchor || n && n.divideBy(2, !0));
  ...
  var ui = li.extend({
    ...
    _detectIconPath: function() {
      ...
      var e = le(t, "background-image") || le(t, "backgroundImage");
      document.body.removeChild(t);
      return (e = this._stripUrl(e)) 
        ? e 
  ...
  var ci = n.extend({
    ...
    _onDrag: function(t) {
      ...
      var i = e._shadow;
      var n = ve(e._icon);
      var o = e._map.layerPointToLatLng(n);
      i && Z(i, n);
      e._latlng = o;
      t.latlng = o;
  ...
  var di = o.extend({
    ...
    initialize: function(t, e) { h(this, e), this._latlng = x(t); },
    onAdd: function(t) {
    ...
    _initIcon: function() {
      var t = this.options;
      var e = "leaflet-zoom-" + (this._zoomAnimated ? "animated" : "hide");
      var i = t.icon.createIcon(this._icon);
      var n = !1;
    ...
    _initInteraction: function() {
      var t;
      this.options.interactive && (M(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), ci && (t = this.options.draggable, this.dragging && (t = this.dragging.enabled(), this.dragging.disable()), this.dragging = new ci(this), t && this.dragging.enable()));
    },
  ...
  var _i = o.extend({
    ...
    _clickTolerance: function() { return (this.options.stroke ? this.options.weight / 2 : 0) + (this._renderer.options.tolerance || 0); }
  });

  var pi = _i.extend({
    options: { fill: !0, radius: 10 },
    initialize: function(t, e) { h(this, e), this._latlng = x(t), this._radius = this.options.radius; },
    setLatLng: function(t) {
      var e = this._latlng;
  ...
  var mi = pi.extend({
    initialize: function(t, e, i) {
      h(this, e = "number" == typeof e ? l({}, i, { radius: e }) : e);
      this._latlng = x(t);
    ...
    _project: function() {
      ...
      var r = this._latlng.lat;
      var a = this._map;
      var h = a.options.crs;
      h.distance === st.distance 
        ? (n = Math.PI / 180, o = this._mRadius / st.R / n, t = a.project([r + o, s]), e = a.project([r - o, s]), e = t.add(e).divideBy(2), i = a.unproject(e).lat, n = Math.acos((Math.cos(o * n) - Math.sin(r * n) * Math.sin(i * n)) / (Math.cos(r * n) * Math.cos(i * n))) / n, !isNaN(n) && 0 !== n || (n = o / Math.cos(Math.PI / 180 * r)), this._point = e.subtract(a.getPixelOrigin()), this._radius = isNaN(n) ? 0 : e.x - a.project([i, s - n]).x, this._radiusY = e.y - t.y) 
  ...
  var fi = _i.extend({
    ...
    initialize: function(t, e) { h(this, e), this._setLatLngs(t); },
    ...
    addLatLng: function(t, e) { return e = e || this._defaultShape(), t = x(t), e.push(t), this._bounds.extend(t), this.redraw(); },
  ...
  var gi = (fi._flat = oi, fi.extend({
    ...
    _clipPoints: function() {
      var t = this._renderer._bounds;
      var e = new p(e = this.options.weight, e);
      var t = new f(t.min.subtract(e), t.max.add(e));
      if (this._parts = [], this._pxBounds && this._pxBounds.intersects(t)) {
        if (this.options.noClip) {
          this._parts = this._rings;
        } else {
          for (var i, n = 0, o = this._rings.length; n < o; n++) (i = Ke(this._rings[n], t, !0)).length && this._parts.push(i);
        }
      }
    },
  ...
  var vi = hi.extend({
    ...
    addData: function(t) {
      ...
      return r.filter && !r.filter(t) || !(s = yi(t, r)) ? this : (s.feature = Mi(t), s.defaultOptions = s.options, this.resetStyle(s), r.onEachFeature && r.onEachFeature(t, s), this.addLayer(s));
    },
    ...
    setStyle: function(e) {
      return this.eachLayer(function(t) { this._setLayerStyle(t, e); }, this);
    },
    _setLayerStyle: function(t, e) { t.setStyle && ("function" == typeof e && (e = e(t.feature)), t.setStyle(e)); }
  });
  ...
  function yi(t, e) {
    ...
    var h = [];
    var l = e && e.pointToLayer;
    var u = e && e.coordsToLatLng || wi;
    if (!a && !r) return null;
    switch (r.type) {
      case "Point":
  ...
  gi.include({
    toGeoJSON: function(t) {
      var e = !I(this._latlngs);
      var i = e && !I(this._latlngs[0]);
      var t = Li(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
  ...
  ai.include({
    toMultiPoint: function(e) {
      var i = [];
      return this.eachLayer(function(t) { i.push(t.toGeoJSON(e).geometry.coordinates); }), Ti(this, { type: "MultiPoint", coordinates: i });
    },
    toGeoJSON: function(e) {
      var i, n, t = this.feature && this.feature.geometry && this.feature.geometry.type;
      return "MultiPoint" === t 
        ? this.toMultiPoint(e) 
        : (i = "GeometryCollection" === t, n = [], this.eachLayer(function(t) {
            t.toGeoJSON && (t = t.toGeoJSON(e), i ? n.push(t.geometry) : "FeatureCollection" === (t = Mi(t)).type ? n.push.apply(n, t.features) : n.push(t));
          }), i 
            ? Ti(this, { geometries: n, type: "GeometryCollection" }) 
  ...
  var Ci = o.extend({
    ...
    initialize: function(t, e, i) { this._url = t, this._bounds = g(e), h(this, i); },
    onAdd: function() {
    ...
    bringToFront: function() { return this._map && ce(this._image), this; },
    bringToBack: function() { return this._map && de(this._image), this; },
    ...
    _initImage: function() {
      ...
      var e = this._image = t ? this._url : P("img");
    ...
    _animateZoom: function(t) {
      ...
      var t = this._map._latLngBoundsToNewLayerBounds(this._bounds, t.zoom, t.center).min;
      ge(this._image, t, e);
    },
    _reset: function() {
      var t = this._image;
      var e = new f(this._map.latLngToLayerPoint(this._bounds.getNorthWest()), this._map.latLngToLayerPoint(this._bounds.getSouthEast()));
      var i = e.getSize();
      Z(t, e.min);
  ...
  var Zi = Ci.extend({
    ...
    _initImage: function() {
      ...
      var e = this._image = t ? this._url : P("video");
      M(e, "leaflet-image-layer");
      this._zoomAnimated && M(e, "leaflet-zoom-animated");
      this.options.className && M(e, this.options.className);
      e.onselectstart = _;
  ...
  var Ei = o.extend({
    ...
    initialize: function(t, e) {
      t && (t instanceof v || u(t)) ? (this._latlng = x(t), h(this, e)) : (h(this, t), this._source = e);
    ...
    toggle: function(t) {
      return this._map 
        ? this.close() 
        : (arguments.length ? this._source = t : t = this._source, this._prepareOpen(), this.openOn(t._map)), this;
    },
    onAdd: function(t) {
    ...
    getLatLng: function() { return this._latlng; },
    setLatLng: function(t) { return this._latlng = x(t), this._map && (this._updatePosition(), this._adjustPan()), this; },
    ...
    bringToFront: function() { return this._map && ce(this._container), this; },
    bringToBack: function() { return this._map && de(this._container), this; },
    _prepareOpen: function(t) {
      if (!(i = this._source)._map) return !1;
      if (i instanceof hi) {
        var e, i = null, n = this._source._layers;
        for (e in n) if (n[e]._map) { i = n[e]; break; }
        if (!i) return !1;
        this._source = i;
      }
      if (!t) {
    ...
    _updateContent: function() {
      if (this._content) {
        ...
        var e = "function" == typeof this._content ? this._content(this._source || this) : this._content;
    ...
    _updatePosition: function() {
      var t, e, i;
      this._map && (e = this._map.latLngToLayerPoint(this._latlng), t = m(this.options.offset), i = this._getAnchor(), this._zoomAnimated 
        ? Z(this._container, e.add(i)) 
        : (t = t.add(e).add(i), e = this._containerBottom = -t.y, i = this._containerLeft = -Math.round(this._containerWidth / 2) + t.x, this._container.style.bottom = e + "px", this._container.style.left = i + "px"));
    },
  ...
  var ki = (A.include({
    ...
    openOn: function(t) {
      return !(t = arguments.length ? t : this._source._map).hasLayer(this) && t._popup && t._popup.options.autoClose && t.removeLayer(t._popup), t._popup = this, Ei.prototype.openOn.call(this, t);
    },
    onAdd: function(t) {
    ...
    _initLayout: function() {
      var t = "leaflet-popup";
      var e = this._container = P("div", t + " " + (this.options.className || "") + " leaflet-zoom-animated");
      var i = this._wrapper = P("div", t + "-content-wrapper", e);
      ...
      if (this.options.closeButton) {
        ...
        S(i, "click", function(t) { O(t), this.close(); }, this);
      }
    },
    _updateLayout: function() {
      ...
      (o && o < n ? (e.height = o + "px", M) : z)(t, "leaflet-popup-scrolled");
    ...
    _adjustPan: function() {
      var t, e, i, n, o, s, r, a;
      this.options.autoPan && (this._map._panAnim && this._map._panAnim.stop(), this._autopanning 
        ? this._autopanning = !1 
        : (t = this._map, e = parseInt(le(this._container, "marginBottom"), 10) || 0, e = this._container.offsetHeight + e, a = this._containerWidth, (i = new p(this._containerLeft, -e - this._containerBottom))._add(ve(this._container)), i = t.layerPointToContainerPoint(i), o = m(this.options.autoPanPadding), n = m(this.options.autoPanPaddingTopLeft || o), o = m(this.options.autoPanPaddingBottomRight || o), s = t.getSize(), r = 0, i.x + a + o.x > s.x && (r = i.x + a - s.x + o.x), i.x - r - n.x < (a = 0) && (r = i.x - n.x), i.y + e + o.y > s.y && (a = i.y + e - s.y + o.y), i.y - a - n.y < 0 && (a = i.y - n.y), (r || a) && (this.options.keepInView && (this._autopanning = !0), t.fire("autopanstart").panBy([r, a]))));
    },
    _getAnchor: function() { return m(this._source && this._source._getPopupAnchor ? this._source._getPopupAnchor() : [0, 0]); }
  }));

  var Oi = (A.mergeOptions({ closePopupOnClick: !0 }), A.include({
    openPopup: function(t, e, i) { return this._initOverlay(ki, t, e, i).openOn(this), this; },
    closePopup: function(t) { return (t = arguments.length ? t : this._popup) && t.close(), this; }
  }), o.include({
    bindPopup: function(t, e) {
      return this._popup = this._initOverlay(ki, this._popup, t, e), this._popupHandlersAdded || (this.on({ click: this._openPopup, keypress: this._onKeyPress, remove: this.closePopup, move: this._movePopup }), this._popupHandlersAdded = !0), this;
    },
    ...
    _openPopup: function(t) {
      var e;
      this._popup && this._map && (Ae(t), e = t.layer || t.target, this._popup._source !== e || e instanceof _i ? (this._popup._source = e, this.openPopup(t.latlng)) : this._map.hasLayer(this._popup) ? this.closePopup() : this.openPopup(t.latlng));
    },
    ...
    _setPosition: function(t) {
      ...
      var i = i.layerPointToContainerPoint(t);
      var s = this.options.direction;
      var r = n.offsetWidth;
      var a = n.offsetHeight;
      var h = m(this.options.offset);
      var l = this._getAnchor();
      var i = "top" === s 
        ? (e = r / 2, a) 
        : "bottom" === s 
          ? (e = r / 2, 0) 
  ...
  var Ai = (A.include({
    openTooltip: function(t, e, i) { return this._initOverlay(Oi, t, e, i).openOn(this), this; },
    ...
    _initTooltipInteractions: function(t) {
      var e, i;
      !t && this._tooltipHandlersAdded || (e = t ? "off" : "on", i = { remove: this.closeTooltip, move: this._moveTooltip }, this._tooltip.options.permanent 
        ? i.add = this._openTooltip 
        : (i.mouseover = this._openTooltip, i.mouseout = this.closeTooltip, i.click = this._openTooltip, this._map ? this._addFocusListeners() : i.add = this._addFocusListeners), this._tooltip.options.sticky && (i.mousemove = this._moveTooltip), this[e](i), this._tooltipHandlersAdded = !t);
    },
    openTooltip: function(t) {
      return this._tooltip && (this instanceof hi || (this._tooltip._source = this), this._tooltip._prepareOpen(t) && (this._tooltip.openOn(this._map), this.getElement ? this._setAriaDescribedByOnLayer(this) : this.eachLayer && this.eachLayer(this._setAriaDescribedByOnLayer, this))), this;
    },
    ...
    _setAriaDescribedByOnLayer: function(t) { (t = "function" == typeof t.getElement && t.getElement()) && t.setAttribute("aria-describedby", this._tooltip._container.id); },
    _openTooltip: function(t) {
      var e;
      this._tooltip && this._map && (this._map.dragging && this._map.dragging.moving() && !this._openOnceFlag 
        ? (this._openOnceFlag = !0, (e = this)._map.once("moveend", function() { e._openOnceFlag = !1, e._openTooltip(t); })) 
  ...
  var Bi = (li.Default = ui, o.extend({
    ...
    bringToFront: function() { return this._map && (ce(this._container), this._setAutoZIndex(Math.max)), this; },
    bringToBack: function() { return this._map && (de(this._container), this._setAutoZIndex(Math.min)), this; },
    getContainer: function() { return this._container; },
    ...
    _updateOpacity: function() {
      if (this._map && !b.ielt9) {
        ...
        i && (r(this._fadeFrame), this._fadeFrame = y(this._updateOpacity, this));
      }
    },
    _onOpaqueTile: _,
    ...
    _updateLevels: function() {
      ...
      if (void 0 !== t) {
        ...
        var o = this._map;
        return n || ((n = this._levels[t] = {}).el = P("div", "leaflet-tile-container leaflet-zoom-animated", this._container), n.el.style.zIndex = e, n.origin = o.project(o.unproject(o.getPixelOrigin()), t).round(), n.zoom = t, this._setZoomTransform(n, o.getCenter(), o.getZoom()), _(n.el.offsetWidth), this._onCreateLevel(n)), this._level = n;
      }
    },
    _onUpdateLevel: _,
    _onRemoveLevel: _,
    ...
    _retainParent: function(t, e, i, n) {
      var i = i - 1;
      var o = ((o = new p(+(t = Math.floor(t / 2)), +(e = Math.floor(e / 2)))).z = i, this._tileCoordsToKey(o));
    ...
    _setView: function(t, e, i, n) {
      var o = Math.round(e);
      var o = void 0 !== this.options.maxZoom && o > this.options.maxZoom || void 0 !== this.options.minZoom && o < this.options.minZoom 
        ? void 0 
        : this._clampZoom(o);
    ...
    _setZoomTransform: function(t, e, i) {
      ...
      var e = t.origin.multiplyBy(n).subtract(this._map._getNewPixelOrigin(e, i)).round();
      b.any3d ? ge(t.el, e, n) : Z(t.el, e);
    },
    _resetGrid: function() {
      var t = this._map;
      var e = t.options.crs;
      var i = this._tileSize = this.getTileSize();
    ...
    _getTiledPixelBounds: function(t) {
      ...
      var e = i.getZoomScale(e, this._tileZoom);
      var t = i.project(t, this._tileZoom).floor();
      var i = i.getSize().divideBy(2 * e);
    ...
    _update: function(t) {
      if (n = this._map) {
        ...
        if (void 0 === t && (t = n.getCenter()), void 0 !== this._tileZoom) {
          ...
          var s = o.getCenter();
          var r = [];
          var n = this.options.keepBuffer;
          var a = new f(o.getBottomLeft().subtract([n, -n]), o.getTopRight().add([n, -n]));
          ...
          if (1 < Math.abs(e - this._tileZoom)) {
            ...
            r.sort(function(t, e) { return t.distanceTo(s) - e.distanceTo(s); });
            if (0 !== r.length) {
    ...
    _addTile: function(t, e) {
      ...
      var o = this.createTile(this._wrapCoords(t), a(this._tileReady, this, t));
      this._initTile(o);
    ...
    _tileReady: function(t, e, i) {
      ...
      var n = this._tileCoordsToKey(t);
      (i = this._tiles[n]) && (i.loaded = +new Date, this._map._fadeAnimated 
        ? (C(i.el, 0), r(this._fadeFrame), this._fadeFrame = y(this._updateOpacity, this)) 
        : (i.active = !0, this._pruneTiles()), e || (M(i.el, "leaflet-tile-loaded"), this.fire("tileload", { tile: i.el, coords: t })), this._noTilesToLoad() && (this._loading = !1, this.fire("load"), b.ielt9 || !this._map._fadeAnimated ? y(this._pruneTiles, this) : setTimeout(a(this._pruneTiles, this), 250)));
    },
  ...
  var Ii = Bi.extend({
    ...
    initialize: function(t, e) {
      ...
      (e = h(this, e)).detectRetina && b.retina && 0 < e.maxZoom 
        ? (e.tileSize = Math.floor(e.tileSize / 2), e.zoomReverse 
          ? (e.zoomOffset--, e.minZoom = Math.min(e.maxZoom, e.minZoom + 1)) 
          : (e.zoomOffset++, e.maxZoom = Math.max(e.minZoom, e.maxZoom - 1)), e.minZoom = Math.max(0, e.minZoom)) 
        : e.zoomReverse 
    ...
    getTileUrl: function(t) {
      ...
      if (this._map && !this._map.options.crs.infinite) {
        var t = this._globalTileRange.max.y - t.y;
        this.options.tms && (e.y = t);
        e["-y"] = t;
      }
      return q(this._url, l(e, this.options));
    },
    ...
    _getSubdomain: function(t) { return t = Math.abs(t.x + t.y) % this.options.subdomains.length, this.options.subdomains[t]; },
    _abortLoading: function() {
      var t, e, i;
      for (t in this._tiles) {
        this._tiles[t].coords.z !== this._tileZoom && ((i = this._tiles[t].el).onload = _, i.onerror = _, i.complete || (i.src = K, e = this._tiles[t].coords, T(i), delete this._tiles[t], this.fire("tileabort", { tile: i, coords: e })));
      }
    },
    _removeTile: function(t) {
      var e = this._tiles[t];
  ...
  var Ni = Ii.extend({
    ...
    getTileUrl: function(t) {
      ...
      var e = (i = c((i = this._crs).project(e[0]), i.project(e[1]))).min;
      var i = i.max;
      var e = (1.3 <= this._wmsVersion && this._crs === ri ? [e.y, e.x, i.y, i.x] : [e.x, e.y, i.x, i.y]).join(",");
  ...
  var Di = (Ii.WMS = Ni, Ri.wms = function(t, e) { return new Ni(t, e); }, o.extend({
    options: { padding: 0.1 },
    initialize: function(t) { h(this, t), d(this), this._layers = this._layers || {}; },
    onAdd: function() {
    ...
    _updateTransform: function(t, e) {
      ...
      var n = this._map.getSize().multiplyBy(0.5 + this.options.padding);
      var o = this._map.project(this._center, e);
      var n = n.multiplyBy(-i).add(o).subtract(this._map._getNewPixelOrigin(t, e));
    ...
    _update: function() {
      ...
      var i = this._map.containerPointToLayerPoint(e.multiplyBy(-t)).round();
  ...
  var ji = Di.extend({
    ...
    _update: function() {
      var t, e, i, n;
      this._map._animatingZoom && this._bounds || (Di.prototype._update.call(this), t = this._bounds, e = this._container, i = t.getSize(), n = b.retina ? 2 : 1, Z(e, t.min), e.width = n * i.x, e.height = n * i.y, e.style.width = i.x + "px", e.style.height = i.y + "px", b.retina && this._ctx.scale(2, 2), this._ctx.translate(-t.min.x, -t.min.y), this.fire("update"));
    },
    _reset: function() {
      Di.prototype._reset.call(this);
    ...
    _requestRedraw: function(t) { this._map && (this._extendRedrawBounds(t), this._redrawRequest = this._redrawRequest || y(this._redraw, this)); },
    ...
    _handleMouseHover: function(t, e) {
      if (!this._mouseHoverThrottled) {
        ...
        setTimeout(a(function() { this._mouseHoverThrottled = !1; }, this), 32);
      }
    },
  ...
  function Hi(t) { return b.canvas ? new ji(t) : null; }
  ...
  var Mt = {
    ...
    _update: function() { this._map._animatingZoom || (Di.prototype._update.call(this), this.fire("update")); },
    _initPath: function(t) {
    ...
    _updateStyle: function(t) {
      ...
      } else e && (o.removeChild(e), t._stroke = null);
      if (n.fill) {
        i = i || (t._fill = Wi("fill"));
        o.appendChild(i);
        i.color = n.fillColor || n.color;
        i.opacity = n.fillOpacity;
      } else i && (o.removeChild(i), t._fill = null);
    },
    _updateCircle: function(t) {
      var e = t._point.round();
      var i = Math.round(t._radius);
      var n = Math.round(t._radiusY || i);
      this._setPath(t, t._empty() ? "M0 0" : "AL " + e.x + "," + e.y + " " + i + "," + n + " 0,23592600");
    },
    _setPath: function(t, e) { t._path.v = e; },
    _bringToFront: function(t) { ce(t._container); },
    _bringToBack: function(t) { de(t._container); }
  };
  ...
  var Ui = Di.extend({
    ...
    _update: function() {
      var t, e, i;
      this._map._animatingZoom && this._bounds || (Di.prototype._update.call(this), e = (t = this._bounds).getSize(), i = this._container, this._svgSize && this._svgSize.equals(e) || (this._svgSize = e, i.setAttribute("width", e.x), i.setAttribute("height", e.y)), Z(i, t.min), i.setAttribute("viewBox", [t.min.x, t.min.y, e.x, e.y].join(" ")), this.fire("update"));
    },
    _initPath: function(t) {
    ...
    _updateStyle: function(t) {
      ...
      var t = t.options;
      e && (t.stroke 
        ? (e.setAttribute("stroke", t.color), e.setAttribute("stroke-opacity", t.opacity), e.setAttribute("stroke-width", t.weight), e.setAttribute("stroke-linecap", t.lineCap), e.setAttribute("stroke-linejoin", t.lineJoin), t.dashArray ? e.setAttribute("stroke-dasharray", t.dashArray) : e.removeAttribute("stroke-dasharray"), t.dashOffset ? e.setAttribute("stroke-dashoffset", t.dashOffset) : e.removeAttribute("stroke-dashoffset")) 
        : e.setAttribute("stroke", "none"), t.fill 
    ...
    _updateCircle: function(t) {
      var e = t._point;
      var i = Math.max(Math.round(t._radius), 1);
      var n = "a" + i + "," + (Math.max(Math.round(t._radiusY), 1) || i) + " 0 1,0 ";
      var e = t._empty() ? "M0 0" : "M" + (e.x - i) + "," + e.y + n + 2 * i + ",0 " + n + 2 * -i + ",0 ";
      this._setPath(t, e);
    },
    _setPath: function(t, e) { t._path.setAttribute("d", e); },
    _bringToFront: function(t) { ce(t._path); },
    _bringToBack: function(t) { de(t._path); }
  });

  function Vi(t) { return b.svg || b.vml ? new Ui(t) : null; }
  ...
  A.include({
    ...
    _createRenderer: function(t) { return this.options.preferCanvas && Hi(t) || Vi(t); }
  });

  var qi = gi.extend({
    initialize: function(t, e) { gi.prototype.initialize.call(this, this._boundsToLatLngs(t), e); },
  ...
  var _t = (Ui.create = Fi, Ui.pointsToPath = dt, vi.geometryToLayer = yi, vi.coordsToLatLng = wi, vi.coordsToLatLngs = bi, vi.latLngToCoords = Pi, vi.latLngsToCoords = Li, vi.getFeature = Ti, vi.asFeature = Mi, A.mergeOptions({ boxZoom: !0 }), n.extend({
  ...
  var zt = (A.addInitHook("addHandler", "boxZoom", _t), A.mergeOptions({ doubleClickZoom: !0 }), n.extend({
    ...
    _onDoubleClick: function(t) {
      var e = this._map;
      var i = e.getZoom();
      var n = e.options.zoomDelta;
      var i = t.originalEvent.shiftKey ? i - n : i + n;
      "center" === e.options.doubleClickZoom ? e.setZoom(i) : e.setZoomAround(t.containerPoint, i);
    }
  }));

  var Gi = (A.addInitHook("addHandler", "doubleClickZoom", zt), A.mergeOptions({ dragging: !0, inertia: !0, inertiaDeceleration: 3400, inertiaMaxSpeed: 1 / 0, easeLinearity: 0.2, worldCopyJump: !1, maxBoundsViscosity: 0 }), n.extend({
    addHooks: function() {
      var t;
    ...
    _onDragStart: function() {
      ...
      this._map.options.maxBounds && this._map.options.maxBoundsViscosity 
        ? (t = g(this._map.options.maxBounds), this._offsetLimit = c(this._map.latLngToContainerPoint(t.getNorthWest()).multiplyBy(-1), this._map.latLngToContainerPoint(t.getSouthEast()).multiplyBy(-1).add(this._map.getSize())), this._viscosity = Math.min(1, Math.max(0, this._map.options.maxBoundsViscosity))) 
    ...
    _onZoomEnd: function() {
      ...
      var e = this._map.latLngToLayerPoint([0, 0]);
    ...
    _onPreDragWrap: function() {
      ...
      var i = this._initialWorldOffset;
      var n = ((o = this._draggable._newPos.x) - e + i) % t + e - i;
      var o = (o + e + i) % t - e - i;
      var t = Math.abs(n + i) < Math.abs(o + i) ? n : o;
      this._draggable._absPos = this._draggable._newPos.clone();
      this._draggable._newPos.x = t;
    },
    _onDragEnd: function(t) {
      var e, i, n, o, s = this._map, r = s.options;
      var a = !r.inertia || t.noInertia || this._times.length < 2;
      s.fire("dragend", t);
      if (!a && (this._prunePositions(+new Date), t = this._lastPos.subtract(this._positions[0]), a = (this._lastTime - this._times[0]) / 1e3, e = r.easeLinearity, a = (t = t.multiplyBy(e / a)).distanceTo([0, 0]), i = Math.min(r.inertiaMaxSpeed, a), t = t.multiplyBy(i / a), n = i / (r.inertiaDeceleration * e), (o = t.multiplyBy(-n / 2).round()).x || o.y)) {
        o = s._limitOffset(o, s.options.maxBounds);
        y(function() { s.panBy(o, { duration: n, easeLinearity: e, noMoveStart: !0, animate: !0 }); });
      } else {
        s.fire("moveend");
      }
    }
  ...
  var Ct = (A.addInitHook("addHandler", "dragging", Gi), A.mergeOptions({ keyboard: !0, keyboardPanDelta: 80 }), n.extend({
    ...
    _onKeyDown: function(t) {
      if (!(t.altKey || t.ctrlKey || t.metaKey)) {
        ...
        if (n in this._panKeys) {
          o._panAnim && o._panAnim._inProgress || (i = this._panKeys[n], t.shiftKey && (i = m(i).multiplyBy(3)), o.options.maxBounds && (i = o._limitOffset(m(i), o.options.maxBounds)), o.options.worldCopyJump 
  ...
  var Zt = (A.addInitHook("addHandler", "keyboard", Ct), A.mergeOptions({ scrollWheelZoom: !0, wheelDebounceTime: 40, wheelPxPerZoomLevel: 60 }), n.extend({
    ...
    _onWheelScroll: function(t) {
      var e = Ne(t);
      var i = this._map.options.wheelDebounceTime;
      var e = (this._delta += e, this._lastMousePos = this._map.mouseEventToContainerPoint(t), this._startTime || (this._startTime = +new Date), Math.max(i - (+new Date - this._startTime), 0));
    ...
    _performZoom: function() {
      var t = this._map;
      var e = t.getZoom();
      var i = this._map.options.zoomSnap || 0;
      var n = (t._stop(), this._delta / (4 * this._map.options.wheelPxPerZoomLevel));
      var n = 4 * Math.log(2 / (1 + Math.exp(-Math.abs(n)))) / Math.LN2;
      var i = i ? Math.ceil(n / i) * i : n;
      var n = t._limitZoom(e + (0 < this._delta ? i : -i)) - e;
      this._delta = 0;
  ...
  var St = (A.addInitHook("addHandler", "scrollWheelZoom", Zt), A.mergeOptions({ tapHold: b.touchNative && b.safari && b.mobile, tapTolerance: 15 }), n.extend({
    ...
    _onMove: function(t) { t = t.touches[0], this._newPos = new p(t.clientX, t.clientY); },
    _isTapValid: function() { return this._newPos.distanceTo(this._startPos) <= this._map.options.tapTolerance; },
    _simulateEvent: function(t, e) { (t = new MouseEvent(t, { bubbles: !0, cancelable: !0, view: window, screenX: e.screenX, screenY: e.screenY, clientX: e.clientX, clientY: e.clientY }))._simulated = !0, e.target.dispatchEvent(t); }
  }));

  var Et = (A.addInitHook("addHandler", "tapHold", St), A.mergeOptions({ touchZoom: b.touch, bounceAtZoomLimits: !0 }), n.extend({
    ...
    _onTouchMove: function(t) {
      if (t.touches && 2 === t.touches.length && this._zooming) {
        ...
        var n = e.mouseEventToContainerPoint(t.touches[1]);
        var o = i.distanceTo(n) / this._startDist;
    ...
    _onTouchEnd: function() {
      this._moved && this._zooming 
        ? (this._zooming = !1, r(this._animRequest), k(document, "touchmove", this._onTouchMove, this), k(document, "touchend touchcancel", this._onTouchEnd, this), this._map.options.zoomAnimation 
